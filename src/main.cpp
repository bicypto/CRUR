...
unsigned int nTargetSpacing = 1 * 30; // CRUR - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // CRUR - time to elapse before new modifier is computed
...
const string strMessageMagic = "CRUR Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CRUR", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/world-us-canada-41796255";
        CTransaction txNew;
        txNew.nTime = 1509313703;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xa7c94698baa0112e76f444d5945e0d3103b7d9a732a906bc523e4e0a0b66be25"));
