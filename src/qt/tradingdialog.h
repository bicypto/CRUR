...
private slots:
    ...
    void on_BuyCRUR_clicked();
    void on_SellCRURBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputCRUR_textChanged(const QString &arg1);
    ...
    QString BuyCRUR(QString OrderType, double Quantity, double Rate);
    QString SellCRUR(QString OrderType, double Quantity, double Rate);
